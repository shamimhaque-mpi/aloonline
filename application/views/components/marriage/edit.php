            ...
            <div class="panel-body" ng-cloak>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?=($marriage->name)?>" placeholder="Enter Name" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Age <span class="req">*</span></label>
                                <input type="text" name="age" value="<?=($marriage->age)?>" placeholder="Age" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-control selectpicker" data-live-search="true" required>
                                    <option value="male" <?=($marriage->gender=='male'?'selected':'')?>>Male</option>
                                    <option value="female"<?=($marriage->gender=='female'?'selected':'')?>>Female</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="marital_status" class="form-control selectpicker" data-live-search="true" required>
                                    <option value="unmarried"  <?=($marriage->marital_status=='unmarried'?'selected':'')?>>Unmarried</option>
                                    <option value="married"  <?=($marriage->marital_status=='married'?'selected':'')?>>Married</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="district_id" class="form-control selectpicker" data-live-search="true" required>
                                    ...
                                    ?>
                                            <option value="<?=($row->id)?>" <?=($row->id==$marriage->district_id?'selected':'')?>><?=($row->name)?></option>
                                        <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="religion" class="form-control" required>
                                    ...
                                    <option value="muslim" <?=($marriage->religion=='muslim'?'selected':'')?>>Muslim</option>
                                    <option value="hindu" <?=($marriage->religion=='hindu'?'selected':'')?>>Hindu</option>
                                    <option value="christian" <?=($marriage->religion=='christian'?'selected':'')?>>Christian</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile" value="<?=($marriage->mobile)?>" placeholder="Mobile" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Address <span class="req">*</span></label>
                                <textarea id="mytextarea2" name="address" class="form-control" rows="3"><?=($marriage->address)?></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Description <span class="req">*</span></label>
                                <textarea id="mytextarea" name="description"><?=($marriage->description)?></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="set-photo-wrapper">
                                <div class="feature_photo">
                                    <img src="<?=site_url($marriage->photo)?>" alt="">
                                </div>
                        ...
                        <input type="hidden" name="old_photo" value="<?=($marriage->photo)?>">
                    </div>
                    <div class="row">
                        <div class="col-md-12">
