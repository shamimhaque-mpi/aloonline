                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" placeholder="Enter Car title" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="mytextarea2" name="description" class="form-control" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
